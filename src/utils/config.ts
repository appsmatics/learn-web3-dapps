...
export const getDataIndexingItems = () : ChainType[] => {
  return [CHAINS_CONFIG[CHAINS.THE_GRAPH]]
}

export const getIdentityItems = () : ChainType[] => {
  return [CHAINS_CONFIG[CHAINS.CERAMIC]]
}

export const getStorageItems = () : ChainType[] => {
  return [CHAINS_CONFIG[CHAINS.ARWEAVE]]
}

export const getChainsList = () : ChainType[] => {
  return [
    CHAINS_CONFIG[CHAINS.SOLANA], 
    CHAINS_CONFIG[CHAINS.AVALANCHE],
    CHAINS_CONFIG[CHAINS.POLYGON],
    CHAINS_CONFIG[CHAINS.NEAR],
    CHAINS_CONFIG[CHAINS.POLKADOT],
    CHAINS_CONFIG[CHAINS.TEZOS],
    CHAINS_CONFIG[CHAINS.SECRET],
